    ...
    internal class PlatformAdaptor_X64 : PlatformAdaptorBase
    {
        ...
        public override TypeInfo Create(ParameterInfo param, bool returnValue)
        {
            ...
            switch(size)
            {
                ...
                default: return new TypeInfo(type, ParamOrReturnType.STRUCTURE_AS_REF_PARAM);
            }
        }
...
{{
    ...
    typedef void (*NativeMethod)({paramAndReturnListStr});
    ((NativeMethod)(method->methodPointer))({paramAndReturnNameListStr});
}}
");
            }
            else
