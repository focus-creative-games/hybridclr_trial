...
namespace HybridCLR.Editor.Settings
{
    public class HybridCLRSettingsProvider : SettingsProvider
    {
        ...
        private SerializedProperty _encryptionSeed;
        ...
        private void InitGUI()
        {
            ...
            _enableEncryption = _serializedObject.FindProperty("enableEncryption");
            _encryptionSeed = _serializedObject.FindProperty("encryptionSeed");
        }
        ...
        public override void OnGUI(string searchContext)
        {
            using (CreateSettingsWindowGUIScope())
            {
                ...
                EditorGUILayout.PropertyField(_enableEncryption);
                if (HybridCLRSettings.Instance.enableEncryption)
                {
                    EditorGUILayout.PropertyField(_encryptionSeed);
                }
